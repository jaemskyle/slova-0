...
var G__32198 = o;
(G__32198[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__32200__i < G__32200__a.length) {G__32200__a[G__32200__i] = arguments[G__32200__i + 0]; ++G__32200__i;}
  args = new cljs.core.IndexedSeq(G__32200__a,0,null);
} 
...
var G__32204 = jsprops;
(G__32204["defaultValue"] = value);

(G__32204["onChange"] = ((function (G__32204,v,value,on_change){
return (function (p1__32203_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__32203_SHARP_);
});})(G__32204,v,value,on_change))
);
...
var vec__32207 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__32207,(0),null);
var id = cljs.core.nth.call(null,vec__32207,(1),null);
var class$ = cljs.core.nth.call(null,vec__32207,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___32211 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___32211 == null)){
} else {
var key_32212 = temp__5461__auto___32211;
(jsprops["key"] = key_32212);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__32213 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__32213["name"] = c);
...
var len__31375__auto___32218 = arguments.length;
var i__31376__auto___32219 = (0);
while(true){
if((i__31376__auto___32219 < len__31375__auto___32218)){
args__31382__auto__.push((arguments[i__31376__auto___32219]));

var G__32220 = (i__31376__auto___32219 + (1));
i__31376__auto___32219 = G__32220;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq32216){
var G__32217 = cljs.core.first.call(null,seq32216);
var seq32216__$1 = cljs.core.next.call(null,seq32216);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__32217,seq32216__$1);
});
...
break;
default:
var G__32223 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__32223;
continue;
...
var n__31141__auto___32225 = a.length;
var i_32226 = (0);
while(true){
if((i_32226 < n__31141__auto___32225)){
(a[i_32226] = reagent.impl.template.as_element.call(null,(a[i_32226])));

var G__32227 = (i_32226 + (1));
i_32226 = G__32227;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__31141__auto___32228 = a.length;
var i_32229 = (0);
while(true){
if((i_32229 < n__31141__auto___32228)){
var val_32230 = (a[i_32229]);
if((cljs.core.vector_QMARK_.call(null,val_32230)) && ((reagent.impl.template.key_from_vec.call(null,val_32230) == null))){
(o["no-key"] = true);
} else {
}

(a[i_32229] = reagent.impl.template.as_element.call(null,val_32230));

var G__32231 = (i_32229 + (1));
i_32229 = G__32231;
continue;
} else {
}
...
var ctx = ({});
var vec__32232 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__32232,(0),null);
var derefed = cljs.core.nth.call(null,vec__32232,(1),null);
...
var G__32235 = (cljs.core.count.call(null,argv) - first_child);
switch (G__32235) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__32235){
...
//# sourceMappingURL=template.js.map?rel=1511975713626
