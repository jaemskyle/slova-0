...
var o40455 = temp__5455__auto__;
var temp__5455__auto____$1 = (o40455["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o40456 = temp__5455__auto____$1;
return (o40456["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__39536__auto__ = f;
return (o__39536__auto__["toString"]).call(o__39536__auto__);
} else {
return "";
}
}catch (e40457){var _ = e40457;
return "";
}});
...
try{var o__39536__auto___40459 = t;
(o__39536__auto___40459["cljs$lang$ctorPrWriter"]).call(o__39536__auto___40459,t,writer);
}catch (e40458){var __40460 = e40458;
}
...
var char_code = (function (){var o__39536__auto__ = (new String(char$));
return (o__39536__auto__["charCodeAt"]).call(o__39536__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__39536__auto__ = String;
return (o__39536__auto__["fromCharCode"]).call(o__39536__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__40461 = num_code;
switch (G__40461) {
case (1):
return (185);
...
var o__39536__auto__ = String;
return (o__39536__auto__["fromCharCode"]).call(o__39536__auto__,superscript_code);
});
/**
...
}catch (e40463){var _e__39543__auto__ = e40463;
return false;
}})())){
...
var vec__40464 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__40464,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o40467 = temp__5455__auto__;
var temp__5455__auto____$1 = (o40467["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o40468 = temp__5455__auto____$1;
return (o40468["nameToPath"]);
} else {
return null;
}
} else {
...
var len__31375__auto___40475 = arguments.length;
var i__31376__auto___40476 = (0);
while(true){
if((i__31376__auto___40476 < len__31375__auto___40475)){
args__31382__auto__.push((arguments[i__31376__auto___40476]));

var G__40477 = (i__31376__auto___40476 + (1));
i__31376__auto___40476 = G__40477;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__40471){
var vec__40472 = p__40471;
var ns_detector = cljs.core.nth.call(null,vec__40472,(0),null);
...
var G__40478 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__40479 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__40478;
remaining_tokens = G__40479;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq40469){
var G__40470 = cljs.core.first.call(null,seq40469);
var seq40469__$1 = cljs.core.next.call(null,seq40469);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__40470,seq40469__$1);
});
...
var vec__40483 = cljs.core.split_with.call(null,(function (p1__40482_SHARP_){
return cljs.core.not_EQ_.call(null,p1__40482_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__40483,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__40483,(1),null);
...
var vec__40486 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__40486,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__40486,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__40489 = cljs.core.rest.call(null,remaining_tokens);
var G__40490 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__40489;
name_tokens = G__40490;
continue;
} else {
...
var vec__40493 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__40493,(0),null);
var arity = cljs.core.nth.call(null,vec__40493,(1),null);
var vec__40496 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__40496,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__40496,(1),null);
var vec__40499 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__40499,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__40499,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__40499,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__40499,(3),null);
...
var vec__40505 = result;
var munged_ns = cljs.core.nth.call(null,vec__40505,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__40505,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__40505,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__40505,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__40505,(4),null);
var arity = cljs.core.nth.call(null,vec__40505,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__40509 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__40509,(0),null);
var args = cljs.core.nth.call(null,vec__40509,(1),null);
var vec__40512 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__40512,(0),null);
var name = cljs.core.nth.call(null,vec__40512,(1),null);
...
var G__40515 = (arity + (1));
var G__40516 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__40517){
var vec__40518 = p__40517;
var arity = cljs.core.nth.call(null,vec__40518,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__40518,(1),null);
...
return cljs.core.get.call(null,arities,p1__40521_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__40522_SHARP_);
...
var args__31382__auto__ = [];
var len__31375__auto___40529 = arguments.length;
var i__31376__auto___40530 = (0);
while(true){
if((i__31376__auto___40530 < len__31375__auto___40529)){
args__31382__auto__.push((arguments[i__31376__auto___40530]));

var G__40531 = (i__31376__auto___40530 + (1));
i__31376__auto___40530 = G__40531;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__40525){
var vec__40526 = p__40525;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__40526,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq40523){
var G__40524 = cljs.core.first.call(null,seq40523);
var seq40523__$1 = cljs.core.next.call(null,seq40523);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__40524,seq40523__$1);
});
...
var map__40534 = options;
var map__40534__$1 = ((((!((map__40534 == null)))?((((map__40534.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__40534.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__40534):map__40534);
var include_ns_QMARK_ = cljs.core.get.call(null,map__40534__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__40534__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__40534__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__40534__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__40535 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__40535,(0),null);
var fn_name = cljs.core.nth.call(null,vec__40535,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__40535,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__40535,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__40535,(4),null);
var arity = cljs.core.nth.call(null,vec__40535,(5),null);
...
var o__39536__auto__ = f;
return (o__39536__auto__["getBasis"]).call(o__39536__auto__);
});
/**
...
}catch (e40539){var _e__39543__auto__ = e40539;
...
var G__40540 = (obj[cljs.core.first.call(null,path)]);
var G__40541 = cljs.core.rest.call(null,path);
obj = G__40540;
path = G__40541;
continue;
} else {
...
return (function (accum,p__40542){
var vec__40543 = p__40542;
var bit = cljs.core.nth.call(null,vec__40543,(0),null);
var protocol = cljs.core.nth.call(null,vec__40543,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__40546){
var vec__40547 = p__40546;
var ns = cljs.core.nth.call(null,vec__40547,(0),null);
var name = cljs.core.nth.call(null,vec__40547,(1),null);
var selector = cljs.core.nth.call(null,vec__40547,(2),null);
...
return (function (p__40551){
var vec__40552 = p__40551;
var munged_name = cljs.core.nth.call(null,vec__40552,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__40552,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__40552,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__40550_SHARP_){
return (obj[cljs.core.first.call(null,p1__40550_SHARP_)]);
});})(name,sorted_matches,vec__40552,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1511975723570
