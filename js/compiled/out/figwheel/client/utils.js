...
return (new CustomEvent(event_name,(function (){var obj37219 = {"detail":data};
return obj37219;
})()));
} else {
...
var f = (function (){var pred__37226 = cljs.core._EQ_;
var expr__37227 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__37226.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__37227))){
return ((function (pred__37226,expr__37227){
return (function (p1__37220_SHARP_){
return console.warn(p1__37220_SHARP_);
});
;})(pred__37226,expr__37227))
} else {
if(cljs.core.truth_(pred__37226.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__37227))){
return ((function (pred__37226,expr__37227){
return (function (p1__37221_SHARP_){
return console.debug(p1__37221_SHARP_);
});
;})(pred__37226,expr__37227))
} else {
if(cljs.core.truth_(pred__37226.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__37227))){
return ((function (pred__37226,expr__37227){
return (function (p1__37222_SHARP_){
return console.error(p1__37222_SHARP_);
});
;})(pred__37226,expr__37227))
} else {
return ((function (pred__37226,expr__37227){
return (function (p1__37223_SHARP_){
return console.log(p1__37223_SHARP_);
});
;})(pred__37226,expr__37227))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__37230){
...
var eval_fn = cljs.core.get.call(null,map__37231__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__37233_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__37235,(0),null);
var v = cljs.core.nth.call(null,vec__37235,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1511975719663
